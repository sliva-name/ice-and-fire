...
This is an incomplete, modified subset for the Ice and Fire Minecraft 26.2 /
Forge 65.1.3 migration, not an official Citadel release or a general-purpose
replacement. It is packaged only as a required companion jar for this
unofficial 26.2 Ice and Fire port.
