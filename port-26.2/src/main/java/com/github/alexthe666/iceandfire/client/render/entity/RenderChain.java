...
public class RenderChain {
    ...
    public static void render(LivingEntity entityLivingIn, float partialTicks, PoseStack matrixStackIn, SubmitNodeCollector bufferIn, int lightIn) {
    ...
    public static <E extends Entity> void renderLink(LivingEntity entityLivingIn, float partialTicks, PoseStack matrixStackIn, SubmitNodeCollector bufferIn, int lightIn, E chainTarget) {
        ...
        bufferIn.submitCustomGeometry(matrixStackIn, RenderTypes.entityCutout(getTexture()), (pose, ivertexbuilder) -> {
            Matrix4f matrix4f = pose.pose();
            vertex(ivertexbuilder, matrix4f, f19, f4, f20, j, k, l, 0.4999F, f30, lightIn);
            vertex(ivertexbuilder, matrix4f, f19, 0.0F, f20, j, k, l, 0.4999F, f29, lightIn);
            vertex(ivertexbuilder, matrix4f, f21, 0.0F, f22, j, k, l, 0.0F, f29, lightIn);
            vertex(ivertexbuilder, matrix4f, f21, f4, f22, j, k, l, 0.0F, f30, lightIn);

            vertex(ivertexbuilder, matrix4f, f23, f4, f24, j, k, l, 0.4999F, f31, lightIn);
            vertex(ivertexbuilder, matrix4f, f23, 0.0F, f24, j, k, l, 0.4999F, f32, lightIn);
            vertex(ivertexbuilder, matrix4f, f25, 0.0F, f26, j, k, l, 0.0F, f32, lightIn);
            vertex(ivertexbuilder, matrix4f, f25, f4, f26, j, k, l, 0.0F, f31, lightIn);
        });
        matrixStackIn.popPose();
    }

    private static void vertex(VertexConsumer p_229108_0_, Matrix4f p_229108_1_, float p_229108_3_, float p_229108_4_, float p_229108_5_, int p_229108_6_, int p_229108_7_, int p_229108_8_, float p_229108_9_, float p_229108_10_, int packedLight) {
