...
public class ClientEvents {
    ...
    public void onPostRenderLiving(RenderLivingEvent.Post event) {
        ...
        if (FrozenProperties.isFrozen(entity)) {
            RenderFrozenState.render(entity, event.getPoseStack(), Minecraft.getInstance().renderBuffers().bufferSource(), event.getState().lightCoords);
        }
        RenderChain.render(entity, partialTick, event.getPoseStack(), Minecraft.getInstance().renderBuffers().bufferSource(), event.getState().lightCoords);
    }
