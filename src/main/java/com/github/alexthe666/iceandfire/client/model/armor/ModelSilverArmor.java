...
public class ModelSilverArmor extends ArmorModelBase {
    ...
    public AdvancedModelBox faceGuard;
    public AdvancedModelBox helmWingR;
    public AdvancedModelBox crest;
    public AdvancedModelBox helmWingL;
    public AdvancedModelBox robeLower;
    public AdvancedModelBox robeLowerBack;

    public ModelSilverArmor(ModelPart modelPart) {
        super(modelPart);
    }
    ...
    public static MeshDefinition createMesh(CubeDeformation deformation, float offset) {
        ...
        partdefinition.getChild("head").getChild("hat").addOrReplaceChild("crest", CubeListBuilder.create().texOffs(18, 32).addBox(0.0F, -0.5F, 0.0F, 1, 9, 9), PartPose.offsetAndRotation(0.0F, -7.9F, -0.1F, 1.2292353921796064F, 0.0F, 0.0F));
    ...
    public static ModelPart getBakedModel(boolean inner) {
        return bakeArmor(inner, ModelSilverArmor::createMesh);
    }
