...
public class WorldGenLightningDragonCave extends WorldGenDragonCave {
    public static Identifier LIGHTNING_DRAGON_CHEST = Identifier.fromNamespaceAndPath(IceAndFire.MODID, "chest/lightning_dragon_female_cave");
    public static Identifier LIGHTNING_DRAGON_CHEST_MALE = Identifier.fromNamespaceAndPath(IceAndFire.MODID, "chest/lightning_dragon_male_cave");
