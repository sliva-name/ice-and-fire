...
public class ItemCopperArmor extends Item implements IafArmorIdentity {

    private final com.github.alexthe666.citadel.server.item.CustomArmorMaterial iafMaterial;
    public ItemCopperArmor(com.github.alexthe666.citadel.server.item.CustomArmorMaterial material, EquipmentSlot slot) {
