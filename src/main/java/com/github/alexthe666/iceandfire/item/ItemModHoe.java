...
public class ItemModHoe extends HoeItem implements DragonSteelOverrides<ItemModHoe> {
    ...
    public ItemModHoe(ToolMaterial toolmaterial, Item.Properties properties) {
        super(DragonSteelOverrides.toolMaterial(toolmaterial),
            DragonSteelOverrides.attackDamageBaseline(toolmaterial, 5.0F, 1.0F), -3.0F, properties);
